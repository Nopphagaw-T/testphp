					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="img/product1.jpg" class="girl img-responsive" alt="">
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="img/product1.jpg" alt="<?= $product_name ?>">
											<h2><?= $price?></h2>
											<p><?= $product_code ?></p>
											<p><?= $product_name ?></p>
										</div>
...
<a id="scrollUp" href="#top" style="position: fixed; z-index: 2147483647; display: block;"><i class="fa fa-angle-up"></i></a></body>